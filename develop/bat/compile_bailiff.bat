...
rmic -d %BLD% -classpath %CLP% -depend %PNR%.%MCL%
...
jar uf %DST%/%MCL%-dl.jar -C %BLD% %PPR%/Bailiff_Stub.class 
jar uf %DST%/%MCL%-dl.jar -C %BLD% %PPR%/Bailiff_Skel.class 
