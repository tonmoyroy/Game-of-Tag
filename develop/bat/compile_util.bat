...
rem -- This file compiles the Util.
rem -- Arguments: 
rem --   With no arguments compiles the service.
rem --   clean             Cleans out the Util class tree.
rem --
...
set LVL=1.4
echo Javac Logger
javac -source %LVL% -target %LVL% -d %BLD% -classpath %CLP% -sourcepath %SRC% %SRC%\%PPR%\Logger.java
IF ERRORLEVEL 1 GOTO :eof

echo Javac CmdlnOption
javac -source %LVL% -target %LVL% -d %BLD% -classpath %CLP% -sourcepath %SRC% %SRC%\%PPR%\CmdlnOption.java
IF ERRORLEVEL 1 GOTO :eof

echo Javac Commandline
javac -source %LVL% -target %LVL% -d %BLD% -classpath %CLP% -sourcepath %SRC% %SRC%\%PPR%\Commandline.java
IF ERRORLEVEL 1 GOTO :eof
...
rem set MNF=%ROOT%\mf\%MCL%.manifest
...
rem -- The Java archive.

jar  cf %DST%/util.jar -C %BLD% %PPR%/Logger.class
jar  uf %DST%/util.jar -C %BLD% %PPR%/CmdlnOption.class
jar  uf %DST%/util.jar -C %BLD% %PPR%/Commandline.class
