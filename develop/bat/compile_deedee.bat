...
jar uf %DST%/%MCL%.jar -C %SRC% %PPR%/Angry.gif
jar uf %DST%/%MCL%.jar -C %SRC% %PPR%/Asleep.gif
jar uf %DST%/%MCL%.jar -C %SRC% %PPR%/BasicSmile.gif
jar uf %DST%/%MCL%.jar -C %SRC% %PPR%/Concerned.gif
jar uf %DST%/%MCL%.jar -C %SRC% %PPR%/HappilySurprised.gif
jar uf %DST%/%MCL%.jar -C %SRC% %PPR%/Laughing.gif
jar uf %DST%/%MCL%.jar -C %SRC% %PPR%/Moody.gif
jar uf %DST%/%MCL%.jar -C %SRC% %PPR%/Waiting.gif
jar uf %DST%/%MCL%.jar -C %SRC% %PPR%/VeryAngry.gif
